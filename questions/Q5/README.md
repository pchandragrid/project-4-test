...
| `understand-anything-plugin/skills/understand/tour-builder-prompt.md` | [View File](https://github.com/Lum1104/Understand-Anything/blob/main/understand-anything-plugin/skills/understand/tour-builder-prompt.md) |
| `understand-anything-plugin/packages/core/src/analyzer/tour-generator.ts` | [View File](https://github.com/Lum1104/Understand-Anything/blob/main/understand-anything-plugin/packages/core/src/analyzer/tour-generator.ts) |
| `understand-anything-plugin/packages/dashboard/src/store.ts` | [View File](https://github.com/Lum1104/Understand-Anything/blob/main/understand-anything-plugin/packages/dashboard/src/store.ts) |


### How the evidence was stitched together

By referencing both the generative `tour-generator.ts` in the core engine and the consumption pattern in the dashboard's `store.ts`, I deduced that tours are injected directly into the `graph.tour` artifact at build-time. This eliminates runtime model dependency in the dashboard UI.

## Practical design implications

| ✨ Design Implication | Description |
|---|---|
| **Impact 1** | Dashboard load stays lightweight. |
| **Impact 2** | Guided onboarding is available immediately after analysis. |
| **Impact 3** | The same graph snapshot yields the same tour for all viewers. |
| **Impact 4** | The project can support browsing even when live model access is unavailable. |
